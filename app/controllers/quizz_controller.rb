class QuizzController < ApplicationController
  ...
  def result
    ...
    @green_qualities = ['acceptance', 'altruism', 'sensitive', 'open sexuality', 'appreciation', 'community', 'sustainable', 'environment', 'emotions' 'awareness', 'balance', 'compassion', 'contribution', 'co-operation', 'diversity', 'empathy', 'encouragement', 'fairness', 'equality', 'generosity', 'happiness', 'world-peace', 'harmony', 'mindfulness', 'openness', 'respect', 'selflessness', 'sharing', 'spirituality', 'humanistic', 'caring', 'vegetarian', 'protect minorities'].sort
    @yellow_qualities = ['systemic', 'conceptual', 'adaptability', 'congruence', 'directness', 'funcionality', 'flexibility', 'humility', 'insightfulness', 'creativity', 'curiosity', 'intuition', 'integrity', 'mastery', 'perceptive', 'reflection', 'spontaneity', 'self-awareness', 'spirituality', 'integral', 'understanding', 'systematic thinking', 'big picture view', 'integration', 'open to all perspectives'].sort
